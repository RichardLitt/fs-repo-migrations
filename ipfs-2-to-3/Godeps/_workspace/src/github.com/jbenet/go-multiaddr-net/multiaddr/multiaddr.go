...
import (
	...
	manet "github.com/ipfs/fs-repo-migrations/ipfs-2-to-3/Godeps/_workspace/src/github.com/jbenet/go-multiaddr-net"
)

var formats = []string{"string", "bytes", "hex", "slice"} // flags
var format string
