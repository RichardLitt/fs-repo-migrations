...
import (
	...
	yamux "github.com/ipfs/fs-repo-migrations/ipfs-2-to-3/Godeps/_workspace/src/github.com/hashicorp/yamux"
	pst "github.com/ipfs/fs-repo-migrations/ipfs-2-to-3/Godeps/_workspace/src/github.com/jbenet/go-peerstream/transport"
)

type stream yamux. // stream implements pst.Stream using a ss.Stream
Stream
