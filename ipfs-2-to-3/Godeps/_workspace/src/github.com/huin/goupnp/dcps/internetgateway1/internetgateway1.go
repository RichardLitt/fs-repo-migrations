...
import (
	...
	"github.com/ipfs/fs-repo-migrations/ipfs-2-to-3/Godeps/_workspace/src/github.com/huin/goupnp/soap"
)

var _ time.Time // Hack to avoid Go complaining if time isn't used.
